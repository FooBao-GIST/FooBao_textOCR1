...
if __name__ == "__main__":
    ocr = PororoOcr()
    image_path_list = glob.glob("/home/user/ocr2/detectedNblured_menu4/*.png")
    image_path_list.sort()
    f = open('menu_ocr.txt', 'w')
    for image_path in image_path_list:
        #image_path = "./menu2_output.png"
        ...
        #print('Result :', text)
        menu_names = ''
        for menu_name in text:
            menu_names += f"{menu_name},"
        f.write(menu_names)
        f.write('\n')
